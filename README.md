...
- **[`next-best-practices`](skills/next-best-practices/SKILL.md)**: Apply Next.js best practices for routing, React Server Components, data, metadata, errors, images, fonts, and bundling. Source: [`vercel-labs/next-skills`](https://github.com/vercel-labs/next-skills/tree/dc1de9caf7612d73f56a8dec3cb1bd6c9ec096b9/skills/next-best-practices).
