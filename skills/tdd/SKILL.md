---
name: tdd
description: Test-driven development for features and bug fixes. Use when the user requests test-first development, a red-green cycle, or a regression test for changed behavior.
---
